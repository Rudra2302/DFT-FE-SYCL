...
//     const int mapShift = ind.get_group(0) * M * K;

//     // Copy Shape Function Values and Gradients to shared memory
// #pragma unroll
//     for (int i = ind.get_local_id(0); i < 2 * N * (K + N); i += ind.get_local_range(0))
//       sharedP[i] = P[i];

//     linearAlgebra::d_streamId.wait();
...
//     // 1st GEMM of P
//     // Z Direction
//     for (int i = ind.get_local_id(0); i < M; i += ind.get_local_range(0))
//       {
//         Type x[N], u[K];
...
//     // 2nd GEMM of P
//     // Y Direction
//     for (int i = ind.get_local_id(0); i < K * N; i += ind.get_local_range(0))
//       {
//         Type y[N], x[K];
...
//     // 3rd GEMM of P
//     // X Direction
//     for (int i = ind.get_local_id(0); i < N * N; i += ind.get_local_range(0))
//       {
//         Type x[N], y[K];
...
//     const int JShift = ind.get_local_range(0) * dim * dim;

//     // Copy Jacobian Factor to shared memory
// #pragma unroll
//     for (int i = ind.get_local_id(0); i < dim * dim; i += ind.get_local_range(0))
...
// #pragma unroll
//     for (int i = ind.get_local_id(0); i < N * N * N; i += ind.get_local_range(0))
//       {
//         Type v[3];
...
//     // 2nd GEMM of PT
//     // Y Direction
//     for (int i = ind.get_local_id(0); i < N * K; i += ind.get_local_range(0))
//       {
//         Type x[K], y[N];
